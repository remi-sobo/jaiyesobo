...
export default function AskDadCard({ pendingCount }: Props) {
  return (
    <div className="mt-12 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-8 items-center p-8 bg-[var(--color-warm-surface)] border border-[var(--color-line)] border-l-[3px] border-l-[var(--color-red)] rounded">
      <div>
