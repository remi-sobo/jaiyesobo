...
export const metadata: Metadata = {
  ...
  description:
    "Pick a team. Snake draft against the AI from the franchise's all-time pool. AI judges who built the better starting 5.",
};
...
export default async function DraftLandingPage() {
  ...
  return (
    <GameShell liveLabel="Snake draft · vs Claude">
      <section className="px-6 lg:px-10 pt-20 pb-10 max-w-[1100px] mx-auto">
        ...
        <p className="text-[var(--color-mute)] text-[0.95rem] max-w-[52ch] leading-relaxed mb-12">
          You go, the AI goes, you go again. Five picks each, ten total. AI judges
          who built the better starting 5 and tells you why.
        </p>
      </section>
